...
1. [README.md](./README.md) — what the library does, the install seam, when to use it
2. [CONTRIBUTING.md](./CONTRIBUTING.md) — layout, dev loop, conventions (incl.
   the patch-target traps), provenance, roadmap, PR flow
3. [`v3/LIMITATIONS.md`](./v3/LIMITATIONS.md) — behavioral edges + force-new-cluster
4. [`v3/reflect/init.go`](./v3/reflect/init.go) — the installer entry points
5. [`examples/basic/main.go`](./examples/basic/main.go) — minimal call site
