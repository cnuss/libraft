// Package libraft installs libraft — etcd's raft consensus replaced by an
...
// EnvURL is the environment variable that activates libraft. Its value is the
...
// The types below re-export the libraft node-construction mirrors from the core.
